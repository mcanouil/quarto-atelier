...
The card here is the site's own social card, wider than the default ratio, so it letterboxes rather than stretches.
Override the `--atelier-embed-art-*` properties in a project stylesheet to resize or straighten it.
